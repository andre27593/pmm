    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnConsultar.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String uri = "content://com.example.alopez.apcontentprovider.UsuariosProvider/usuarios";
                Uri usuariosUri =  Uri.parse(uri);
                Log.e("ContentProvider2", "LLEGAMOS");
                Toast.makeText(getApplicationContext(),"LLEGAMOS", Toast.LENGTH_SHORT).show();
        ...
        btnLlamadas.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Uri llamadasUri =  Uri.parse("content://call_log/calls");
